...
FilmArtsy is a professional network for film crews, creators, and collaborators to showcase work, build credibility, and connect on projects. It combines elements of LinkedIn and creative portfolios for the needs of film-industry workflows.
...
- Helped move the product from concept to a usable mobile app with profiles, feeds, and collaboration workflows.
